...
public class main {
	...
	public static void main(String[] args) {
		...
		Thread thread1 = new Thread(group1, () -> g1.thread1(), "Thread-1");
		Thread thread2 = new Thread(group1, () -> g1.thread2(), "Thread-2");
		Thread thread3 = new Thread(group2, () -> g2.thread3(), "Thread-3");
		Thread thread4 = new Thread(group2, () -> g2.thread4(), "Thread-4");
